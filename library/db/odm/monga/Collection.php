...
namespace Library\Db\Odm\Monga;

use Closure;
use Library\Db\Odm\Monga\Query\Aggregation;
use Library\Db\Odm\Monga\Query\Find;
use Library\Db\Odm\Monga\Query\Indexes;
use Library\Db\Odm\Monga\Query\Remove;
use Library\Db\Odm\Monga\Query\Update;
use Library\Db\Odm\Monga\Query\Where;
use MongoCollection;
...
class Collection
{
    ...
    {
        $indexes = new Indexes($this->collection);
        $callback($indexes);
