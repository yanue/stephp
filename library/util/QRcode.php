...
class QRimage
{
    ...
    //----------------------------------------------------------------------
    public static function buff($frame, $filename = false, $pixelPerPoint = 4, $outerFrame = 4, $saveandprint = FALSE)
    {
...
class QRcode
{
    ...
    //----------------------------------------------------------------------
    public static function buff($text, $outfile = false, $level = QR_ECLEVEL_L, $size = 3, $margin = 4, $saveandprint = false)
    {
        $enc = QRencode::factory($level, $size, $margin);
        return $enc->encodeBuff($text, $outfile, $saveandprint = false);
    }

    // 保持到fdfs
    public static function saveToFdfs($text, $level = QR_ECLEVEL_L, $size = 10, $margin = 0)
    {
        $outfile = ROOT . "/Cache/" . time() . ".png";
        $enc = QRencode::factory($level, $size, $margin);
...
//        var_dump($image);
        ...
        // save into dfs
        $file = Fdfs::getInstance($conf['fastDFS'])->upload_filebuff($image, "png");
...
class QRencode
{
    ...
    //----------------------------------------------------------------------
    public function encodeBuff($intext, $outfile = false, $saveandprint = false)
    {
        try {
